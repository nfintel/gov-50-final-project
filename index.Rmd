...
## Conclusion
Ultimately, my analyses provide support for H1 (), but not for H2 () or H().

For H1, my findings suggest that

For H2, my findings show a statistically significant relationship between the homicide rate and the number of executions. However, contrary to my hypothesis, this relationship/correlation is negative. In other words, as the homicide rate increases, the number of executions decrease, and as the homicide rate decreases, the number of executions increase. This finding was particularly surprising to me and certainly warrants further research. One potential explanation may be reverse causality. Though still widely debated, some scholars maintain that capital punishment/executions act as a deterrent to violent crime. Further analyses, then, should investigate the relationship between these two variables using the number of executions as the explanatory variable and the homicide rate as the response variable. 

For H3, my findings show a statistically significant relationship between the number of exonerations and the number of executions.
